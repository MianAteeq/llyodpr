...
<body
    ...
    <div class="mkdf-title-image">
     <img itemprop="image" src="<?php echo url('/website'); ?>/assets/wp-content/uploads/2018/03/p-title-background-1.jpg" alt="k" />
    </div>
                ...
                @if ($contact)
                    <div class="row">
                        @foreach ($contact as $contact_val)
                            <div class="col-md-6 mt-2 mobile_res">
                                <div class="panel panel-default" style="border:1px solid #5095cc !important;">
                                    <div class="panel-heading" style="background:#5095cc !important;">
                                        <strong>{{ $contact_val->name }}</strong></div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-6 my-3">
                                                <iframe width="100%" height="250"
                                                    src="https://www.google.com/maps/embed/v1/place?q=<?php echo $contact_val->station; ?> &amp;key=AIzaSyBPfcYHVWvCjXPmeXwKcAWYfjib3YZDVzY"></iframe>
                                            </div>
                                            <div class="col-sm-6">
                                                <p class="address">{{ $contact_val->name }}</p>
                                                <label style="width: 100%;">{{ $contact_val->station }}</label>
                                                    ...
                                                    <div class="wpb_wrapper">
                                                        <div class="mkdf-section-title-holder  "
                                                            ...
                                                            <div class="mkdf-st-inner">
                                                                ...
                                                                <h6 class="mkdf-st-text">
                                                                    In case you need legal assistance our team will
                                                                    gladly help.
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="wpb_wrapper">
                                                        @if ($message = Session::get('success'))
                                                            ...
                                                            <div role="form" class="wpcf7"
                                                                ...
                                                                <form action="{{ url('/contact_insert') }}"
                                                                    method="post"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="mkdf-grid-col-12"><span
                                                                                    ...
                                                                                    <textarea name="description" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea"
