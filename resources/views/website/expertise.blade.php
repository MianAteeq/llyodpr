		...
		<div class="mkdf-wrapper-inner">
			...
			<div class="mkdf-content">
				<div class="mkdf-content-inner">
					<div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax" style="height: 430px !important ;background-color: rgba(194,170,128,0.08);background-image:url({{asset('/public/images') .'/'. $expertise_detail->banner}}) !important;" >
										...
										<div class="wpb_wrapper">
											<div class="mkdf-section-title-holder  " style="text-align: center">
												<div class="mkdf-st-inner">
													<h3 class="mkdf-st-title" style="font-size:35px !important; font-weight: bold !important;">
										...
										<div class="row">
											<section class="col-sm-12">
												...
												<ol class="breadcrumb">
													...
													<li class="active last"> <strong style="color: black; font-weight:bold;"> {{$expertise_detail->title}} </strong></li>
												</ol> <a id="main-content"></a>
												<div class="region region-content">
													<section id="block-system-main" class="block block-system clearfix">
														<div id="node-6" class="node node-page clearfix" about="/business-crime-confiscation" typeof="foaf:Document">
															<div class="content">
											...
											<section class="col-sm-12">
												<ol class="breadcrumb">
													<br>
													<!-- <li class="first"><a href="/serious-complex-crime" title="{{$expertise_detail->title}}" class="active-trail"> <strong> Expertise </strong> </a></li> -->
													<li class="active last"> <strong style="color: black; font-weight:bold;"> {{$ex->title}} </strong></li>
												</ol> <a id="main-content"></a>
												<div class="region region-content">
													<section id="block-system-main" class="block block-system clearfix">
														<div id="node-6" class="node node-page clearfix" about="/business-crime-confiscation" typeof="foaf:Document">
