		...
		<div id="text-10" class="widget mkdf-sidearea widget_text">
			...
			<div class="textwidget">
				<p><a href="https://www.google.rs/maps/place/The+Nomad+Hotel/@40.7461394,-73.9883576,14.75z/data=!4m15!1m9!2m8!1z0KXQvtGC0LXQu9C4!3m6!1z0KXQvtGC0LXQu9C4!2z0IrRg9GY0L7RgNC6LCDQodGY0LXQtNC40ZrQtdC90LUg0JTRgNC20LDQstC1!3s0x89c24fa5d33f083b:0xc80b8f06e177fe62!4m2!1d-74.0059728!2d40.7127753!3m4!1s0x89c259a60a2beaf9:0xac8f81eb5975ef53!8m2!3d40.7449648!4d-73.9885479">1170
					...
					Email: <a href="../cdn-cgi/l/email-protection.html#7c1d120b1d10083c0d131819151208190e1d1f08150a19521f1311"><span class="__cf_email__" data-cfemail="afcec1d8cec3dbefdec0cbcac6c1dbcaddceccdbc6d9ca81ccc0c2">[email&#160;protected]</span></a>
				</p>
			</div>
		</div>
				...
				<div class="mkdf-content-inner">
					<div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax" style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(assets/wp-content/uploads/2018/03/p-title-background-1.jpg);" data-height="430">
						<div class="mkdf-title-image">
							<img itemprop="image" src="assets/wp-content/uploads/2018/03/p-title-background-1.jpg" alt="k" />
						</div>
								...
								<div class="mkdf-page-content-holder mkdf-grid-col-12">
									<div class="mkdf-row-grid-section-wrapper ">
										<div class="mkdf-row-grid-section">
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1522765588588">
									...
									<div class="mkdf-row-grid-section-wrapper ">
										<div class="mkdf-row-grid-section">
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1522765555428">
									...
									<div class="vc_empty_space" style="height: 65px"><span class="vc_empty_space_inner"></span></div>
									<div data-parallax-bg-image="https://anwalt.qodeinteractive.com/wp-content/uploads/2018/04/p-our-team-parallax-1.jpg" data-parallax-bg-speed="1" class="vc_row wpb_row vc_row-fluid vc_custom_1522768485758 mkdf-parallax-row-holder">
										<div class="wpb_column vc_column_container vc_col-sm-12">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="vc_row wpb_row vc_inner vc_row-fluid">
														<div class="wpb_column vc_column_container vc_col-sm-10 vc_col-lg-offset-1 vc_col-lg-10 vc_col-md-offset-2 vc_col-md-8 vc_col-sm-offset-1">
															<div class="vc_column-inner">
																<div class="wpb_wrapper">
																	<div class="mkdf-section-title-holder  " style="text-align: center">
																		<div class="mkdf-st-inner">
																			<h3 class="mkdf-st-title" style="color: #ffffff">
																				Rewards we are proud of </h3>
																			<div class="mkdf-separator-holder clearfix  mkdf-separator-center mkdf-separator-normal">
																				<div class="mkdf-separator" style="border-color: #ffffff;width: 143px;border-bottom-width: 2px">
																				</div>
																			</div>
																			<h6 class="mkdf-st-text" style="color: #ffffff">
																				Impressive number of successful law
																				cases in our portfolio is a confirmation
																				of our quality. </h6>
																		</div>
																	</div>
																</div>
													...
													<div class="mkdf-row-grid-section-wrapper mkdf-content-aligment-center">
														<div class="mkdf-row-grid-section">
															<div class="vc_row wpb_row vc_inner vc_row-fluid">
																<div class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-offset-1 vc_col-lg-2 vc_col-md-offset-0 vc_col-md-4 vc_col-sm-offset-0 vc_col-xs-offset-3 vc_col-xs-6">
																	<div class="vc_column-inner">
																		<div class="wpb_wrapper">
																			<div class="mkdf-single-image-holder   ">
																				<div class="mkdf-si-inner">
																					<img width="135" height="131" src="assets/wp-content/uploads/2018/04/p-our-team-icon-1.png" class="attachment-full size-full" alt="i" loading="lazy" />
																				</div>
																			</div>
																...
																<div class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-offset-0 vc_col-lg-2 vc_col-md-offset-0 vc_col-md-4 vc_col-sm-offset-0 vc_col-xs-offset-3 vc_col-xs-6">
																	<div class="vc_column-inner">
																		<div class="wpb_wrapper">
																			<div class="mkdf-single-image-holder   ">
																				<div class="mkdf-si-inner">
																					<img width="135" height="131" src="assets/wp-content/uploads/2018/04/p-our-team-icon-2.png" class="attachment-full size-full" alt="i" loading="lazy" />
																				</div>
																			</div>
																			<div class="vc_empty_space" style="height: 50px"><span class="vc_empty_space_inner"></span>
																			</div>
																...
																<div class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-offset-0 vc_col-lg-2 vc_col-md-offset-0 vc_col-md-4 vc_col-sm-offset-0 vc_col-xs-offset-3 vc_col-xs-6">
																	<div class="vc_column-inner">
																		<div class="wpb_wrapper">
																			<div class="mkdf-single-image-holder   ">
																				<div class="mkdf-si-inner">
																					<img width="135" height="131" src="assets/wp-content/uploads/2018/04/p-our-team-icon-3.png" class="attachment-full size-full" alt="i" loading="lazy" />
																				</div>
																			</div>
																			<div class="vc_empty_space" style="height: 50px"><span class="vc_empty_space_inner"></span>
																			</div>
																...
																<div class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-offset-0 vc_col-lg-2 vc_col-md-offset-0 vc_col-md-4 vc_col-sm-offset-0 vc_col-xs-offset-3 vc_col-xs-6">
																	<div class="vc_column-inner">
																		<div class="wpb_wrapper">
																			<div class="mkdf-single-image-holder   ">
																				<div class="mkdf-si-inner">
																					<img width="135" height="131" src="assets/wp-content/uploads/2018/04/p-our-team-icon-4.png" class="attachment-full size-full" alt="i" loading="lazy" />
																				</div>
																			</div>
																			<div class="vc_empty_space" style="height: 50px"><span class="vc_empty_space_inner"></span>
																			</div>
																...
																<div class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-offset-0 vc_col-lg-2 vc_col-md-offset-0 vc_col-md-4 vc_col-sm-offset-0 vc_col-xs-offset-3 vc_col-xs-6">
																	<div class="vc_column-inner">
																		<div class="wpb_wrapper">
																			<div class="mkdf-single-image-holder   ">
																				<div class="mkdf-si-inner">
																					<img width="135" height="131" src="assets/wp-content/uploads/2018/04/p-our-team-icon-5.png" class="attachment-full size-full" alt="i" loading="lazy" />
																				</div>
																			</div>
																			<div class="vc_empty_space" style="height: 50px"><span class="vc_empty_space_inner"></span>
																			</div>
