        ...
        <span class="mkdf-social-icon-widget   ion-social-pinterest   "></span> </a>
            ...
            <div class="mkdf-content">
                <div class="mkdf-content-inner">
                    <div class="mkdf-title-holder mkdf-standard-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax"
                                                ...
                                                @foreach ($postss as $post)
                                                    <div class="mkdf-related-post blog_mobile">
                                                        <div class="mkdf-related-post-inner">
                                                            ...
                                                            <h5 itemprop="name" class="entry-title mkdf-post-title"><a
                                                                    itemprop="url"
                                                                    href="{{ url('/blog_detail') . '/' . $post->id }}"
                                                                    title="The lawyers club"
                                                                    style="font-size: 22px;font-weight: bold;">{{ $post['title'] }}</a>
                                                            </h5>
