...
<head>
	...
	<link rel="stylesheet" href="<?php echo asset('/public/website') ?>/assets/cookies/demo.css">
	<script src="<?php echo asset('/public/website') ?>/assets/cookies/demo.js" defer></script>

	<link rel="stylesheet" href="<?php echo asset('/public/website') ?>/assets/cookies/cookieconsent.css" media="print" onload="this.media='all'">
...
<body class="home page-template page-template-full-width page-template-full-width-php page page-id-13 theme-anwalt anwalt-core-1.1.2 woocommerce-no-js anwalt-ver-1.4 mkdf-smooth-page-transitions mkdf-smooth-page-transitions-preloader mkdf-grid-1300 mkdf-sticky-header-on-scroll-down-up mkdf-dropdown-animate-height mkdf-header-standard mkdf-menu-area-shadow-disable mkdf-menu-area-in-grid-shadow-disable mkdf-menu-area-in-grid-border-disable mkdf-logo-area-border-disable mkdf-side-menu-slide-from-right mkdf-woocommerce-columns-3 mkdf-woo-normal-space mkdf-woo-pl-info-below-image mkdf-woo-single-thumb-below-image mkdf-woo-single-has-pretty-photo mkdf-default-mobile-header mkdf-sticky-up-mobile-header mkdf-header-top-enabled mkdf-search-covers-header wpb-js-composer js-comp-ver-6.4.1 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
	...
	<a href="https://web.whatsapp.com/send?phone=4407802444938" target="_blank" class="whatsapp"><i class="mkdf-social-icon-widget ion-social-whatsapp"></i></a>
			<a href="https://www.facebook.com/lloydsprsolicitors1/photos/?ref=page_internal" target="_blank" class="facebook"><i class="mkdf-social-icon-widget ion-social-facebook"></i></a>
			<a href="https://twitter.com/LloydsPRUK" target="_blank" class="linkedin"><i class="mkdf-social-icon-widget ion-social-twitter"></i></a>
			<a href="https://www.linkedin.com/company/lloydsprsolicitors/about/" target="_blank" class="google"><i class="mkdf-social-icon-widget ion-social-linkedin"></i></a>
			<a href="https://uk.trustpilot.com/review/lloydspr.com" target="_blank" class="twitter"><img src="{{URL::to('public/trust.png')}}" alt="Trust Pilot" /></a>
						...
						<div class="mkdf-position-right">
							<div class="mkdf-position-right-inner">
								...
								<div class="widget mkdf-vertical-separator-widget mkdf-vertical-separator-full-height"><span class="mkdf-vsw-height-holder"></span><span class="mkdf-vsw" style="vertical-align:middle;height:100%;border-left-style:solid;margin-left:30px"></span>
									...
									<span style="margin-left: 17px"> <strong style="font-size:17px">Emergency Number</strong>:<a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" data-hover-color="#6c5835" style="color: #ffffff;;font-size: 18px;margin: 0px 0px 0px 6px;" href="tel:07802444938" target="_blank"> 07802444938</a> <span class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" style="font-size: 26px;color: white">/</span> <a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" data-hover-color="#6c5835" style="color: #ffffff;;font-size: 18px;margin: 0px 0px 0px 6px;" href="tel:07956845769" target="_blank">07956845769</a></span> 
									...
									<div class="mkdf-page-content-holder mkdf-grid-col-12">
																...
																<rs-module id="rev_slider_2_2" data-version="6.2.23">
																	<rs-slides>
																		...
																		<rs-slide data-key="rs-{{$slider_key}}" data-title="Slide" data-thumb="//anwalt.qodeinteractive.com/assets/wp-content/uploads/2018/03/h1-slider1-background-img-100x50.jpg" data-anim="ei:d;eo:d;s:d;r:0;t:slideremoveleft;sl:d;" data-firstanim="t:fade;s:300;sl:7;">
																			<img src="https://mtechserv-581124343.imgix.net/{{$slider_val->image}}?q=75&auto=format" title="Main Home" data-parallax="8" class="rev-slidebg" data-no-retina>
																			...
																			<rs-layer id="slider-2-slide-2-layer-1" data-type="text" data-color="#5095cc" data-xy="xo:300px,120px,75px,40px;y:m;yo:-52px,-51px,-48px,-111px;" data-dim="w:auto,auto,auto,303px;h:auto,auto,auto,111px;" data-basealign="slide" data-rsp_o="off" data-rsp_bd="off" data-frame_0="y:50px;tp:600;" data-frame_1="tp:600;e:circ.out;st:900;sp:800;sR:900;" data-frame_999="o:0;tp:600;st:w;sR:1800;" style="z-index:6; line-height: 70px; padding: 12px;">
																				<h5 class="slider_txt" style="background: rgba(0, 0, 0, 0.5);padding:10px 10px;">
																					<strong> {{$slider_val->title}} -Legal 500 </strong>
																				</h5>
																				<div style="display: flex; align-items:center;">
																					<h5 class="slider_txt" style="width: auto !important; ">
																			...
																			<rs-layer id="slider-2-slide-2-layer-4" data-type="text" data-color="#000000" data-xy="xo:300px,120px,75px,40px;y:m;yo:142px,128px,122px,123px;" data-text="l:22;a:inherit;" data-basealign="slide" data-rsp_o="on" data-rsp_bd="on" data-frame_0="y:50px;tp:600;" data-frame_1="tp:600;e:circ.out;st:1300;sp:800;sR:1300;" data-frame_999="o:0;tp:600;st:w;sR:1400;" style="z-index:8;">
																				<a href="tel:07802444932" class="mkdf-btn mkdf-btn-medium mkdf-btn-solid" style="width: 205px !important;">
										...
										<div class="mkdf-row-grid-section-wrapper ">
											<div class="mkdf-row-grid-section">
												<div class="vc_row wpb_row vc_row-fluid vc_custom_1520428609185" style="padding-top: 0px !important;">
													<div class="mkdf-row-grid-section-wrapper ">
														<div class="mkdf-row-grid-section">
															<div class="vc_row wpb_row vc_row-fluid vc_custom_1522406045702" style="padding-top: 50px !important; padding-bottom: 25px !important;">
																	...
																	<div class="mkdf-iwt clearfix  mkdf-iwt-icon-top mkdf-iwt-icon-medium ">
																		...
																		<div class="mkdf-iwt-content">
																			<h5 class="mkdf-iwt-title" style="margin-top: 9px">
																				<a itemprop="url" href="{{url('/expertise').'/'.str_replace(" ","_",$expertise_val['title'])}}" target="_self">
																					<span class="mkdf-iwt-title-text blog-mobile">{{$expertise_val->title}}</span>
																				</a>
																			</h5>
																			...
																			<a itemprop="url" aria-label="go TO Detail view about expertuise" style="font-size:8px" href="{{url('/expertise').'/'.str_replace(" ","_",$expertise_val['title'])}}" target="_self" class="mkdf-btn mkdf-btn-medium mkdf-btn-simple mkdf-btn-icon mkdf-btn-icon-animate">
                                                                            Read More About {{$expertise_val->title}}
										...
										<div class="vc_row wpb_row vc_row-fluid call-us vc_custom_1522659030108 mkdf-content-aligment-center" style="background-color:#5095cc">
											<div class="wpb_column vc_column_container vc_col-sm-12">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<h4><span style="color: #ffffff;">Emergency? Call us
																		now</span> <a href="tel:07802444938">+07802444938</a> <span style="color: white;margin-right: -2px;"> / </span> <a href="tel:+07956845769">+07956845769</a></h4>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="mkdf-row-grid-section-wrapper mb-4">
											<div class="mkdf-row-grid-section abouttxt" style="margin-top: 0px; margin-bottom: 70px;">
												<div class="vc_row wpb_row vc_row-fluid">
													<div class="wpb_column vc_column_container vc_col-sm-12">
														<div class="vc_column-inner">
															<div class="wpb_wrapper">
																<div class="mkdf-elements-holder mkdf-two-columns  mkdf-responsive-mode-1024 ">
																	<div class="mkdf-eh-item     " data-item-class="mkdf-eh-custom-7575" data-1024-1366="0% 7% 4.4% 8% " data-368-1024="103px 10px 0px" data-680-768="103px 53px 0px" data-680="101px 0% 0px">
																		<div class="mkdf-eh-item-inner">
																			<div class="mkdf-eh-item-content mkdf-eh-custom-7575" style="padding: 0 5% 4% 4%">
																				<div class="wpb_text_column wpb_content_element ">
																					<div class="wpb_wrapper">
																						<!-- <h4>About Us</h4> -->
																						<div class="mkdf-row-grid-section-wrapper ">
																				...
																				<div class="wpb_text_column wpb_content_element ">
																					<div class="wpb_wrapper">
																						<p style="text-align: justify;color:#656565!important">
																	...
																	<div class="mkdf-eh-item" data-item-class="mkdf-eh-custom-4679" data-1024-1366="140px 8%" data-768-1024="70px 133px 140px" data-680-768="70px 53px 140px" data-680="70px 0% 140px">
																		<div class="mkdf-eh-item-inner" style="margin-top: 153px;">
																			<div class="mkdf-eh-item-content mkdf-eh-custom-4679" style="padding: 0px!important;">
																				<div class="mkdf-single-image-holder   ">
																					<div class="mkdf-si-inner">
																						<img width="800" height="534" src="https://mtechserv-737011741.imgix.net/h1-img-1111.jpg?ar=2800%3A1400&auto=format%2Ccompress&crop=focalpoint&fit=crop&fp-x=0.49&fp-y=0.552&fp-z=1&ixlib=php-4.1.0&w=1200" class="attachment-full size-full" alt="g" loading="lazy" srcset="https://mtechserv-737011741.imgix.net/h1-img-1111.jpg?ar=2800%3A1400&auto=format%2Ccompress&crop=focalpoint&fit=crop&fp-x=0.49&fp-y=0.552&fp-z=1&ixlib=php-4.1.0&w=1200 800w" sizes="(max-width: 800px) 100vw, 800px" />
																					</div>
																				</div>
																			</div>
																		</div>
														...
														<div class="wpb_text_column wpb_content_element about-text ">
															<div class="wpb_wrapper wpb_wrapper_mobile">
																<p class="MsoNormal" style="margin-bottom: 7.5pt;line-height: 1.2;background: white;text-align: justify;width: 100%;"><span style="font-family: arial, helvetica, sans-serif; color: #656565; ">Our expertise is recognised in the Legal 500, where it is noted that one of Lloyds PR Solicitors' 'key strengths is its ‘ability to assimilate large volumes of complex material and undertake forensic accountancy analysis, in order to reduce its clients’ liabilities'. Our team are trained in forensically analysing extensive and complex evidence. At Lloyds PR Solicitors we highly value technological developments, and this area is constantly being invested in and updated. This is important when tackling any allegation, particularly in financial crime. This allows us to work efficiently and ensures that we dissect the case mounted against our clients, to provide sound and robust advice at early stages </span></p>
															</div>
														</div>
													</div>
										...
										<!--	</div>-->
										<!--</div>-->
										<div class="mkdf-row-grid-section-wrapper mkdf-parallax-row-holder mkdf-content-aligment-center" data-parallax-bg-image=<?php echo asset('/website/assets/wp-content/uploads/2018/03/h1-parallax-1.jpg') ?> data-parallax-bg-speed=1>
											<div class="mkdf-row-grid-section">
																	...
																	<div class="mkdf-testimonials mkdf-owl-slider" data-number-of-items="1" data-enable-loop="yes" data-enable-autoplay="yes" data-slider-speed="5000" data-slider-speed-animation="600" data-enable-navigation="no" data-enable-pagination="yes">
																		<div class="mkdf-testimonial-content" id="mkdf-testimonials-485">
																			<div class="mkdf-testimonial-text-holder">
																				...
																				<h6 class="mkdf-testimonial-text">“I would like to say, one of hardest lawyer in the UK. They actually work hard to beat my case at court. You can call them at any time of the day. I do recommend anyone to them. I will be using them again..&#039;&#039;</h6>
																				<span class="mkdf-testimonial-author">
																					<span class="mkdf-testimonials-author-name">Parys
																					</span>
																				</span>
																			</div>
																		</div>
																		<div class="mkdf-testimonial-content" id="mkdf-testimonials-174">
																			<div class="mkdf-testimonial-text-holder">
																				...
																				<h6 class="mkdf-testimonial-text">
																					&quot;They have been amazing at helping us through a difficult time.Always informed us on the proceedings and on top of everything.Best firm ever! Thank you very very much! &quot;</h6>
																				<span class="mkdf-testimonial-author">
																					<span class="mkdf-testimonials-author-name">Diana
																					</span>
																				</span>
																			</div>
																		</div>
																		...
																		<div class="mkdf-testimonial-content" id="mkdf-testimonials-485">
																			<div class="mkdf-testimonial-text-holder">
																				...
																				<h6 class="mkdf-testimonial-text">“Best solicitors about highly recommend! Very pleased with the outcome Kept in contact with kept me updated with everything going on Highly recommended.&#039;&#039;</h6>
																				<span class="mkdf-testimonial-author">
																					<span class="mkdf-testimonials-author-name">Alfie
																					</span>
																				</span>
																			</div>
																		</div>
																		<div class="mkdf-testimonial-content" id="mkdf-testimonials-485">
																			<div class="mkdf-testimonial-text-holder">
																				...
																				<h6 class="mkdf-testimonial-text">“Very professional and very helpful. They have been dealing with my case and helped me a lot and it was successful. I want to thank all the team. The best solicitors.&#039;&#039;</h6>
																				<span class="mkdf-testimonial-author">
																					<span class="mkdf-testimonials-author-name">Barent Baro
																					</span>
																				</span>
																			</div>
																		</div>
																		<div class="mkdf-testimonial-content" id="mkdf-testimonials-485">
																			<div class="mkdf-testimonial-text-holder">
																				...
																				<h6 class="mkdf-testimonial-text">“I was extremely happy with the performance of Lloyds PR Solicitors. My case was given their utmost attention and I was kept 'in the loop' with regard to my case at all times; the barrister Lloyds PR instructed was also extremely efficient. I would highly recommend Lloyds to anyone who requires the services of a highly competent firm.&#039;&#039;</h6>
																				<span class="mkdf-testimonial-author">
																					<span class="mkdf-testimonials-author-name">Vissen Chettiar
																					</span>
																				</span>
																			</div>
																		</div>
																		<div class="mkdf-testimonial-content" id="mkdf-testimonials-485">
																			<div class="mkdf-testimonial-text-holder">
																				...
																				<h6 class="mkdf-testimonial-text">“Very professional advice and help. Very fast responses and acceptable price.&#039;&#039;</h6>
																				<span class="mkdf-testimonial-author">
																					<span class="mkdf-testimonials-author-name">Tzveta
																					</span>
																				</span>
																			</div>
																		</div>
									...
									<div class="mkdf-row-grid-section-wrapper ">
										<div class="mkdf-row-grid-section" style="position:unset !important;">
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1521709462158">
												<div class="wpb_column vc_column_container vc_col-sm-12" style="margin-top:90px;">
													<div class="vc_column-inner">
														<div class="wpb_wrapper">
															<div class="mkdf-section-title-holder" style="text-align: center">
																<div class="mkdf-st-inner">
																	<h3 class="mkdf-st-title">
																		Find out about our activities on News & Insights </h3>
																	<div class="mkdf-separator-holder clearfix  mkdf-separator-center mkdf-separator-normal">
																		<div class="mkdf-separator" style="width: 143px;border-bottom-width: 2px">
																		</div>
																	</div>
														...
														<div class="wpb_wrapper">
															<div class="mkdf-blog-list-holder mkdf-bl-standard mkdf-bl-four-columns mkdf-normal-space mkdf-bl-pag-no-pagination   " data-type=standard data-number-of-posts=-1 data-number-of-columns=4 data-space-between-items=normal data-category=interview data-orderby=date data-order=DESC data-image-size=full data-title-tag=h5 data-excerpt-length=10 data-post-info-section=yes data-post-info-image=yes data-post-info-image-zoom=no data-post-info-image-shader=no data-post-info-author=no data-post-info-date=yes data-post-info-category=no data-post-info-comments=no data-post-info-like=no data-post-info-share=no data-pagination-type=no-pagination data-max-num-pages=0 data-next-page=2>
																<div class="mkdf-bl-wrapper mkdf-outer-space">
																	<ul class="mkdf-blog-list" style="display:flex !important; flex-wrap:wrap !important;">
																		@if($posts)
																		...
																		<li class="mkdf-bl-item mkdf-item-space clearfix">
																			<div class="mkdf-bli-inner">
																				...
																				<div class="mkdf-bli-content">
																					...
																					<h5 itemprop="name" class="entry-title mkdf-post-title blog-mobile">
																						<a itemprop="url" href="{{url('/blog_detail').'/'.$post_val->id}}" title="Law and order">
																							{{$post_val->title}} </a>
																					</h5>
																					<div class="mkdf-bli-excerpt">
																						...
																						<div class="mkdf-separator-holder clearfix">
																							<div class="mkdf-separator" style="width: 00px">
																							</div>
																						</div>
