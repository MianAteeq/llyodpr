                            ...
                            <div class="mkdf-position-center-inner">
                                ...
                                <div class="mkdf-mobile-logo-wrapper">
                                    ...
                                    <a itemprop="url" href="{{ url('/') }}" style="height: 80px;">
                                        ...
                                        <img itemprop="image"
                                            src="<?php echo asset('/website'); ?>/assets/wp-content/themes/anwalt/assets/img/logo.png"
                                            alt="Mobile Logo" />
        ...
        <nav class="mkdf-mobile-nav ps ps--theme_default ps--active-y" role="navigation" aria-label="Mobile Menu"
            ...
            <div class="mkdf-grid">
                <ul id="menu-mobile-menu" class="">
                    ...
                    <li id="mobile-menu-item-3088"
                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children  has_sub">
                        <a href="{{ url('/team') }}" class=" current  mkdf-mobile-no-link"><span>Our People</span></a>
                    ...
                    <li id="mobile-menu-item-2999"
                        ...
                        <ul class="sub_menu" style="display: none;">
                            @foreach (App\Models\Expertise::all() as $expert_val)
                                <li id="mobile-menu-item-{{ 3000 + $loop->iteration }}"
                                    class="menu-item menu-item-type-post_type menu-item-object-page ">
                                    <a href="{{ url('/expertise/' . str_replace(' ', '_', $expert_val['title'])) }}"
                                        class=""><span>{{ $expert_val->title }}</span></a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                    ...
                    <li id="mobile-menu-item-3088"
                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children  has_sub">
                        <a href="{{ url('/career') }}" class=" current  mkdf-mobile-no-link"><span>Careers</span></a>

                    </li>
                    <li id="mobile-menu-item-3088"
                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children  has_sub">
                        <a href="{{ url('/blog') }}" class=" current  mkdf-mobile-no-link"><span>News &
                                Insights</span></a>

                    </li>
                    <li id="mobile-menu-item-3088"
                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children  has_sub">
                        <a href="{{ url('/contact') }}" class=" current  mkdf-mobile-no-link"><span>Contact
                                Us</span></a>

                    </li>
                    <li id="mobile-menu-item-3088"
                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children  has_sub">
                        <a href="{{ url('/funding') }}" class=" current  mkdf-mobile-no-link"><span>Funding</span></a>
