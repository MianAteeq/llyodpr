                   ...
                   if (htmlDiv) {
                       ...
                       document.getElementsByTagName('head')[0].appendChild(htmlDiv.childNodes[0]);
                                    ...
                                    <div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax"
                                        style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(website/assets/wp-content/uploads/2018/03/p-title-background-1.jpg);"
                                        data-height="430">
                                        <div class="mkdf-title-image">
                                            <img itemprop="image"
                                                src="<?php echo asset('website'); ?>/assets/wp-content/uploads/2018/03/p-title-background-1.jpg"
                                                alt="k" />
                                        </div>
                                        <div class="mkdf-title-wrapper" style="height: 430px">
                                            <div class="mkdf-title-inner">
                                                <div class="mkdf-grid">
                                                    <h2 class="mkdf-page-title entry-title">Accessibility</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="mkdf-section-title-holder">
                                                                <div class="mkdf-st-inner">
                                                                    ...
                                                                    <p class="mkdf-st-text"
                                                                        ...
                                                                        <?php echo $accessibilty->description; ?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="vc_row wpb_row vc_row-fluid call-us vc_custom_1522660415400 mkdf-content-aligment-center"
                                            ...
                                            <div class="vc_column-inner">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h4><span style="color: #ffffff;">Need a lawyer? We have
                                                                    the
                                                                    best </span> <a
                                                                    href="tel:07956845769">07956845769</a></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
