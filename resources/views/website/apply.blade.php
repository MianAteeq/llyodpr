    ...
    <div class="mkdf-wrapper">
        <div class="mkdf-wrapper-inner">
            ...
            <div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax"
                style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(public/website/assets/wp-content/uploads/2018/03/p-title-background-1.jpg);"
                data-height="430">
                <div class="mkdf-title-image">
                    <img itemprop="image"
                        src="<?php echo url('/website'); ?>/assets/wp-content/uploads/2018/03/p-title-background-1.jpg"
                        alt="k" />
                </div>
                <div class="mkdf-title-wrapper" style="height: 430px">
                    <div class="mkdf-title-inner">
                        <div class="mkdf-grid">
                            <h2 class="mkdf-page-title entry-title">APPLY NOW</h2>
                        </div>
                    </div>
                </div>
            </div>
                                                            ...
                                                            <div class="mkdf-section-title-holder  "
                                                                ...
                                                                <div class="mkdf-st-inner">
                                                                    <h3 class="mkdf-st-title">
                                                                        Be a Part of our Llords PR Family </h3>
                                                                    <div
                                                                    ...
                                                                    <h6 class="mkdf-st-text">
                                                                        In case you need assistance in applying for a
                                                                        job then contact our provider numbers our team
                                                                        will gladly help.
                                                                    </h6>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="wpb_wrapper">
                                                            @if ($message = Session::get('success'))
                                                                ...
                                                                <div role="form" class="wpcf7"
                                                                    id="wpcf7-f1608-p399-o2" lang="en-US"
                                                                    dir="ltr">
                                                                    ...
                                                                    <form action="{{ url('/apply_insert') }}"
                                                                        ...
                                                                        <div>
                                                                            <div
                                                                                class="mkdf-grid-row mkdf-grid-normal-gutter">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="mkdf-grid-col-6"><span
                                                                                        class="wpcf7-form-control-wrap email"><input
                                                                                            type="file"
                                                                                            name="file"
                                                                                            class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" /></span>
                                                                                </div>
                                                                                <!-- <div class="mkdf-grid-col-12"><span class="wpcf7-form-control-wrap textarea"><textarea name="description" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea"
