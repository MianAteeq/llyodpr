					...
					<div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax" style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(public/website/assets/wp-content/uploads/2018/03/Career-page.jpg);" data-height="430">
						...
						<div class="mkdf-title-wrapper" style="height: 430px">
							<div class="mkdf-title-inner">
								<div class="mkdf-grid">
									<!-- <h2 class="mkdf-page-title entry-title" style="color:white;">Careers</h2> -->
								</div>
							</div>
						</div>
					</div>
										...
										<div class="wpb_wrapper">
											<div class="mkdf-section-title-holder  " style="text-align: center">
												<div class="mkdf-st-inner">
													...
													<h6 class="mkdf-st-text" style="    text-align: left;
    padding-top: 21px;
    color: black;
    font-size: 19px;">
                                                      Click here to download the <a target="_blank" style="color:#3598db;text-decoration: underline;" href="https://www.lloydspr.com/public/website/EqualityandDiversityMonitoring.docx">Equality and Diversity Monitoring form 2024 - 2025</a>
													</h6>
												</div>
											</div>
										</div>
									...
									<div class="vc_column-inner">
										<div class="wpb_wrapper" style="margin-bottom:50px;">
											...
											<div class="field-item even" property="content:encoded">
												...
												<p><span style="font-size:26px; color:black !important; font-weight:bold;"><span style="font-family:'Poppins', sans-serif !important;"><strong><u style="font-weight: 600 !important;">{{$career_val->title}}</u></strong></span></span></p>
											...
											<!--	<p style="margin-left:25.0pt;">&nbsp;</p>
												...
												<p>If this position interests you then please email your CV to
													<a href="mailto:recruitment@lloydspr.com"> <strong style=" text-decoration:underline;"> recruitment@lloydspr.com </strong>
													</a>
												</p> --!>
												<!-- <p>Please include your name and which position you are applying for in the subject line.</p> -->
						...
						<div class="col-md-8">
							<div class="row">
								...
								<div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
									<a target="_top" href="{{URL::to('/public/images/career_page.jpg')}}" class="with-caption single-gallery">
										<div class="gallery-thumbnail">
											<img src="{{URL::to('/public/images/career_page.jpg')}}" class="w-100 shadow-1-strong rounded mb-4" alt="ECG" />
										</div>
