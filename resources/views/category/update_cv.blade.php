                        ...
                        <div class="col-lg-10">
                            <div class="border border-3 p-4 rounded">
                                <form action="{{url('/admin/update_cv')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label"> Sort No</label>
                                        <input type="text" class="form-control" name="sort_no" id="inputProductTitle" placeholder="sort no" value="<?php if (!empty($team->sort_no)) {
                                                                                                                                                    echo $team->sort_no;
                                                                                                                                                } ?>">
                                    </div>
                                   <div class="mb-3">
