...
class CategoryController extends Controller
{
    ...
    public function cv($id)
    {
        ...
        return view('category.update_cv', ['categorys' => PracticeCategory::all(), 'user_id' => $id, 'cv_tbl' => $cv, 'cv_desc_tbl' => $cv_desc, 'cv_practice_tbl' => $cv_practice,'team' => $team]);
    }
    ...
    public function update_cv(Request $request)
    {
        ...
        if($request->id==null){
            $cv_id = Cv::create($cv_tbl);
            $request->id=$cv_id['id'];

        }else{
            $cv_id = Cv::find($request->id)->update($cv_tbl);

        }
        
        Team::find($request->user_id)->update([
        ...
        if ($request->practice_category_id) {
            //Insert cv_short_description
