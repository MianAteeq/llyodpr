...
Route::middleware('auth')->group(function () {
    Route::prefix('admin')->group(function () {
       ...
       Route::get('/sort/team', [TeamController::class, 'sortTeam']);
          Route::post('/sort/team', [TeamController::class, 'updateSortTeam'])->name('update.sort');
        ...
        Route::get('/upload_v_card/{id}', [TeamController::class, 'upload_v_card']);
        Route::post('/upload_v_card_post', [TeamController::class, 'upload_v_card_post']);
        /*team*/
        /*Funding*/
...
Route::get('/loadMore/{id}', [WebsiteController::class, 'loadMore']);
Route::get('/team_detail/{id?}', [WebsiteController::class, 'view']);
...
// printPdf
Route::get('/print/pdf/{id?}', [WebsiteController::class, 'printPdf'])->name('print.pdf');
